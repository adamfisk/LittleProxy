...
public final class KeyTool {
     ...
     * @return which one
     */
    private static GeneralName createGeneralName(String t, String v)
            throws Exception {
    ...
    private static ObjectIdentifier findOidForExtName(String type)
            throws Exception {
     ...
     */
    public static CertificateExtensions createV3Extensions(
