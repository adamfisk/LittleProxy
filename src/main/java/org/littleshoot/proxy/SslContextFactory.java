 ...
 * created by this factory sends a bogus certificate defined in {@link ProxyKeyStore}.
 * <p>
...
public class SslContextFactory {
    ...
    static {
        ...
        try {
            ...
            ks.load(ProxyKeyStore.asInputStream(),
                    ProxyKeyStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, ProxyKeyStore.getCertificatePassword());
